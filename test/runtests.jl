...
import Aqua
Aqua.test_unbound_args(InterfaceLimits)
Aqua.test_undefined_exports(InterfaceLimits)
Aqua.test_ambiguities(InterfaceLimits)
Aqua.test_stale_deps(InterfaceLimits)
Aqua.test_deps_compat(InterfaceLimits)
...
function run_tests()
    ...
    IS.open_file_logger(config.filename, config.file_level) do file_logger
        ...
        @time @testset "Begin InterfaceLimits tests" begin
            @includetests ARGS
        end
